...
/**
 * Value associated with the key in the document must equal the filter value.
 *
...
public class Equals
  ...
  public String globalInfo() {
    return "Value associated with the key in the document must equal the filter value.";
  }
