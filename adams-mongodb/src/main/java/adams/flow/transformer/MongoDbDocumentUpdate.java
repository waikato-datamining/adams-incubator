...
/**
 <!-- globalinfo-start -->
 * Updates the documents passing through using the specified operation.
 * <br><br>
 <!-- globalinfo-end -->
 *
 <!-- flow-summary-start -->
...
public class MongoDbDocumentUpdate
  ...
  public void defineOptions() {
    ...
    m_OptionManager.add(
      "operation", "operation",
      new adams.flow.transformer.mongodbdocumentupdate.PassThrough());
  }
