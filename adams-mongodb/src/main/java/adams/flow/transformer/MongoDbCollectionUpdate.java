...
/**
 <!-- globalinfo-start -->
 * Updates the collections passing through using the specified operation.
 * <br><br>
 <!-- globalinfo-end -->
 *
 <!-- flow-summary-start -->
 ...
 * &nbsp;&nbsp;&nbsp;default: MongoDbCollectionUpdate
 * </pre>
 *
...
public class MongoDbCollectionUpdate
  ...
  public void defineOptions() {
    ...
    m_OptionManager.add(
      "operation", "operation",
      new adams.flow.transformer.mongodbcollectionupdate.PassThrough());
  }
