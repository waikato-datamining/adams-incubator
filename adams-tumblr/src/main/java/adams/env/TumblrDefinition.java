...
/**
 * Definition for the Tumblr props file.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class TumblrDefinition
  ...
  /** the key as constant. */
  public final static String KEY = "tumblr";
