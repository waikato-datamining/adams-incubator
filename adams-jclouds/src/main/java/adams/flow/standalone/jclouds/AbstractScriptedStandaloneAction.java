...
/*
 * AbstractScriptedStandaloneAction.java
...
/**
 * Abstract ancestor for actions that execute external scripts.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 * @version $Revision: 8703 $
 */
public abstract class AbstractScriptedStandaloneAction
  extends AbstractJCloudsStandaloneAction
