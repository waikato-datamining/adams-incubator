...
public class Scripted
  extends AbstractScriptedStandaloneAction {

  /** for serialization. */
  private static final long serialVersionUID = 1304903578667689350L;

  /** the loaded script object. */
  protected transient JCloudsStandaloneAction m_ActionObject;
  ...
  protected String check() {
    ...
    if (result == null)
      m_ActionObject = (JCloudsStandaloneAction) m_ScriptObject;
