...
import adams.flow.transformer.jclouds.Dummy;
import adams.flow.transformer.jclouds.JCloudsTransformerAction;

/**
 <!-- globalinfo-start -->
 * Executes a JClouds action that consumes and generates data.
 * <br><br>
 <!-- globalinfo-end -->
 *
 <!-- flow-summary-start -->
 ...
 * </pre>
 * 
 * <pre>-action &lt;adams.flow.transformer.jclouds.JCloudsTransformerAction&gt; (property: action)
 * &nbsp;&nbsp;&nbsp;The JClouds action to execute.
 * &nbsp;&nbsp;&nbsp;default: adams.flow.transformer.jclouds.Dummy
 * </pre>
 * 
 <!-- options-end -->
 *
 ...
 * @version $Revision$
 */
public class JCloudsTransformer
  extends AbstractTransformer {

  private static final long serialVersionUID = -2625144277594271179L;

  /** the action to perform. */
  protected JCloudsTransformerAction m_Action;
  ...
  public String globalInfo() {
    return "Executes a JClouds action that consumes and generates data.";
  }
   ...
   */
  public void setAction(JCloudsTransformerAction value) {
    m_Action = value;
    reset();
  }
   ...
   * @return 		the action
   */
  public JCloudsTransformerAction getAction() {
    return m_Action;
  }
