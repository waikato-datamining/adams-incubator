...
public class Scripted
  extends AbstractScriptedTransformerAction {

  /** for serialization. */
  private static final long serialVersionUID = 1304903578667689350L;

  /** the loaded script object. */
  protected transient JCloudsTransformerAction m_ActionObject;
  ...
  public String globalInfo() {
    return 
	"A sink action that uses any scripting handler for executing the "
  ...
  protected String loadScriptObject() {
	...
	JCloudsTransformerAction.class,
	m_ScriptFile,
	m_ScriptOptions,
  ...
  protected String check() {
    ...
    if (result == null)
      m_ActionObject = (JCloudsTransformerAction) m_ScriptObject;
