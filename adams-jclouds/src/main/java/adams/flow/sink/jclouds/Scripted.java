...
public class Scripted
  extends AbstractScriptedSinkAction {

  /** for serialization. */
  private static final long serialVersionUID = 1304903578667689350L;

  /** the loaded script object. */
  protected transient JCloudsSinkAction m_ActionObject;
  ...
  protected String check() {
    ...
    if (result == null)
      m_ActionObject = (JCloudsSinkAction) m_ScriptObject;
