...
/**
 <!-- globalinfo-start -->
 * Lists the available storage locations.
 * <br><br>
 <!-- globalinfo-end -->
 *
 <!-- options-start -->
...
public class ListStorageLocations
  ...
  public String globalInfo() {
    return "Lists the available storage locations.";
  }
  ...
  protected String doExecute() {
    ...
    context   = (BlobStoreContext) m_Connection.buildView(BlobStoreContext.class);
