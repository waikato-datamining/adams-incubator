...
/**
 * Converts an ArrayList of {@link MiniSeed} objects into a {@link Timeseries}.
 * 
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class MiniSeedListToTimeseries
  ...
  public String globalInfo() {
    return "Converts an ArrayList of MiniSeed objects into a Timeseries object.";
  }
  ...
  protected Object doConvert() throws Exception {
    ...
    result.setID(list.get(0).getSeedName());
