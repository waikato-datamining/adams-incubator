...
/**
 * Test for DL4JDatasetIterator actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class DL4JDatasetIteratorTest
   ...
   */
  public DL4JDatasetIteratorTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(DL4JDatasetIteratorTest.class);
  }
