...
/**
 * Test for DL4JDatasetInfo actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class DL4JDatasetInfoTest
   ...
   */
  public DL4JDatasetInfoTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(DL4JDatasetInfoTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      // Flow.DL4JDatasetInfo
      DL4JDatasetInfo dl4jdatasetinfo = new DL4JDatasetInfo();
      actors.add(dl4jdatasetinfo);
