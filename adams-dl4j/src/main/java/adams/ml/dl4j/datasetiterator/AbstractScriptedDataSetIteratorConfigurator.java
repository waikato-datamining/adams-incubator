...
/**
 * Abstract ancestor for dataset iterator generators that execute external scripts.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 * @version $Revision: 13195 $
 */
public abstract class AbstractScriptedDataSetIteratorConfigurator
  extends AbstractOptionHandler
  implements DataSetIteratorConfigurator, FileBasedScriptingWithOptions {
