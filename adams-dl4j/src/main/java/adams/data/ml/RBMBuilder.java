...
public class RBMBuilder
  extends AbstractBaseNetworkBuilder<RBM> {
  ...
  public String globalInfo() {
    return "Builder for Restricted Boltzman Machine (RBM).";
  }
   ...
   */
  @Override
  protected RBM doTrainNetwork(RBM network, DataSet data) {
    network.setInput(data.getFeatureMatrix());
    network.trainTillConvergence(data.getFeatureMatrix(), m_LearningRate, new Object[]{m_K, m_LearningRate, m_NumEpochs});
