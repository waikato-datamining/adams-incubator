...
/*
 * OpenCVMultiImageOperation.java
...
import adams.data.opencv.multiimageoperation.AbstractOpenCVMultiImageOperation;
...
/**
 <!-- globalinfo-start -->
 * Applies a OpenCV multi-image operation to the incoming image(s) and outputs the generated image(s).
 * <p/>
 <!-- globalinfo-end -->
 *
 <!-- flow-summary-start -->
 ...
 * - generates:<br/>
 * &nbsp;&nbsp;&nbsp;adams.data.boofcv.OpenCVImageContainer<br/>
 * <p/>
 <!-- flow-summary-end -->
 *
 <!-- options-start -->
 ...
 * &nbsp;&nbsp;&nbsp;default: OpenCVMultiImageOperation
 * </pre>
 * 
 ...
 * </pre>
 * 
 * <pre>-operation &lt;adams.data.boofcv.multiimageoperation.AbstractOpenCVMultiImageOperation&gt; (property: operation)
 * &nbsp;&nbsp;&nbsp;The operation to apply to the images.
 * &nbsp;&nbsp;&nbsp;default: adams.data.opencv.multiimageoperation.PassThrough
 * </pre>
 * 
 <!-- options-end -->
 *
 ...
 * @version $Revision$
 */
public class OpenCVMultiImageOperation
  ...
  protected AbstractOpenCVMultiImageOperation m_Operation;

  /** the generated images. */
  protected List<OpenCVImageContainer> m_CurrentImages;
  ...
  public String globalInfo() {
    return
        "Applies a OpenCV multi-image operation to the incoming image(s) and outputs "
  ...
  public void defineOptions() {
    ...
    m_OptionManager.add(
	    "operation", "operation",
	    new adams.data.opencv.multiimageoperation.PassThrough());
  }
   ...
   */
  public void setOperation(AbstractOpenCVMultiImageOperation value) {
    m_Operation = value;
    reset();
  }
   ...
   */
  public AbstractOpenCVMultiImageOperation getOperation() {
    return m_Operation;
  }
  ...
  protected void restoreState(Hashtable<String,Object> state) {
    if (state.containsKey(BACKUP_CURRENTIMAGES)) {
      m_CurrentImages = (List<OpenCVImageContainer>) state.get(BACKUP_CURRENTIMAGES);
  ...
  protected String doExecute() {
    ...
    try {
      ...
      img   = new OpenCVImageContainer[input.length];
      for (i = 0; i < input.length; i++)
	img[i] = OpenCVHelper.toOpenCVImageContainer(input[i]);
