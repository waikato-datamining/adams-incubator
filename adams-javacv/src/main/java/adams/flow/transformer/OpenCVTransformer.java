 ...
 * </pre>
 * 
 * <pre>-transformer &lt;adams.data.opencv.transformer.AbstractOpenCVTransformer&gt; (property: transformAlgorithm)
 * &nbsp;&nbsp;&nbsp;The transformer to use for transformering the image.
 * &nbsp;&nbsp;&nbsp;default: adams.data.opencv.transformer.PassThrough
 * </pre>
 * 
 <!-- options-end -->
 *
...
public class OpenCVTransformer
  ...
  public String globalInfo() {
    return
        "Applies a OpenCV transformation to the incoming image and outputs "
  ...
  public void defineOptions() {
    ...
    m_OptionManager.add(
	    ...
	    new adams.data.opencv.transformer.PassThrough());
  }
   ...
   */
  public void setTransformAlgorithm(AbstractOpenCVTransformer value) {
   ...
   *
   * @return		<!-- flow-generates-start -->adams.data.opencv.OpenCVImageContainer.class<!-- flow-generates-end -->
   */
