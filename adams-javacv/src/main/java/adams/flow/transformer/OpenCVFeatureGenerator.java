...
import adams.data.opencv.features.Pixels;
 ...
 * </pre>
 * 
 * <pre>-algorithm &lt;adams.data.opencv.features.AbstractOpenCVFeatureGenerator&gt; (property: algorithm)
 * &nbsp;&nbsp;&nbsp;The feature generation algorithm to use.
 * &nbsp;&nbsp;&nbsp;default: adams.data.opencv.features.Pixels -converter \"adams.data.featureconverter.SpreadSheetFeatureConverter -data-row-type adams.data.spreadsheet.DenseDataRow -spreadsheet-type adams.data.spreadsheet.SpreadSheet\"
 * </pre>
 * 
 <!-- options-end -->
 *
...
public class OpenCVFeatureGenerator
  ...
  protected String doExecute() {
    ...
    m_Queue.clear();
    try {
      m_Queue.addAll(Arrays.asList(m_Algorithm.generate(OpenCVHelper.toOpenCVImageContainer((AbstractImageContainer) m_InputToken.getPayload()))));
    }
    catch (Exception e) {
