...
/**
 <!-- globalinfo-start -->
 * Turns a BufferedImage container into an OpenCV one.
 * <br><br>
 <!-- globalinfo-end -->
 *
 <!-- options-start -->
 ...
 */
public class BufferedImageToOpenCV
  ...
  public String globalInfo() {
    return "Turns a BufferedImage container into an OpenCV one.";
  }
