...
public class Scripted
  ...
  protected transient AbstractOpenCVFeatureGenerator m_FeatureGeneratorObject;
  ...
  protected String loadScriptObject() {
	...
	AbstractOpenCVFeatureGenerator.class, 
	m_ScriptFile, 
	m_ScriptOptions, 
   ...
   */
  @Override
  protected void checkData(OpenCVImageContainer img) {
    super.checkData(img);

    m_FeatureGeneratorObject = (AbstractOpenCVFeatureGenerator) m_ScriptObject;
  }
  /**
