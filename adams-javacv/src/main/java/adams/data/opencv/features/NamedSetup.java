...
public class NamedSetup
  ...
  /** the actual scheme. */
  protected AbstractOpenCVFeatureGenerator m_ActualScheme;
  ...
  public String globalInfo() {
    return "Applies a OpenCV feature generator that is referenced via its global setup name (see 'NamedSetups').";
  }
   ...
   */
  protected AbstractOpenCVFeatureGenerator getActualScheme() {
    if (m_ActualScheme == null) {
      m_ActualScheme = (AbstractOpenCVFeatureGenerator) m_Setup.getSetup();
      if (m_ActualScheme == null)
