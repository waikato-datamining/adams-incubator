...
public class Scripted
  ...
  protected transient AbstractOpenCVTransformer m_TransformerObject;
  ...
  protected String loadScriptObject() {
	...
	AbstractOpenCVTransformer.class, 
	m_ScriptFile, 
	m_ScriptOptions, 
   ...
   */
  @Override
  protected void checkImage(OpenCVImageContainer img) {
    super.checkImage(img);

    m_TransformerObject = (AbstractOpenCVTransformer) m_ScriptObject;
  }
